...
<%--    Dòng hiện thị thông báo--%>
    <div id="toastMessage" class="toast align-items-center text-white bg-success border-0 position-fixed top-0 end-0" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="d-flex">
                            ...
                            <div class="modal-body">
                                <form id="userForm" action="user" method="post">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control popup" id="fullname" name="fullname" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <input type="text" class="form-control popup" id="username" name="username" required>
                                    </div>
                                    ...
                                    <button type="submit" class="btn btn-primary w-100 py-2 rounded-3 shadow-sm mt-3">Create</button>
                                </form>
                            </div>
                        </div>
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <c:choose>
                                    ...
                                    <c:when test="${user.status == 'Deactivated'}">
                                        <span class="badge bg-danger">${user.status}</span>
                                    </c:when>
                                    <c:when test="${user.status == 'NotVerified'}">
                            ...
                            <td>
                                <a href="user_update?id=<c:out value='${user.id}'/>"

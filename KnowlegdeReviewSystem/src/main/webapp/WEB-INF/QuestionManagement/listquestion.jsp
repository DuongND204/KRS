        ...
        <div class="col p-0">
            ...
            <div class="filter-container">
                <form action="question" method="get" id="filterForm" class="row align-items-end g-3">
                    ...
                    <div class="col-md-4">
                        <label for="subjectFilter" class="form-label">First. Filter by Subject:</label>
                    ...
                    <div class="col-md-4">
                        <label for="lessonFilter" class="form-label">Then. Filter by Lesson:</label>
                        <select id="lessonFilter" name="lessonId" class="form-select">
                            <option value="">All Lessons</option>
                            <% if (lessons != null) {
                                for (Lesson lesson : lessons) { %>
                            <option value="<%= lesson.getId() %>"
                                    data-subject="<%= lesson.getSubjectId() %>" <%= (selectedLessonId != null && selectedLessonId.equals(lesson.getId())) ? "selected" : "" %>>
                                <%= lesson.getTitle() %>
                            </option>
                            <% }
                            } %>
            ...
            <div class="modal-body">
                <form action="question" method="post" id="addQuestionForm">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="subjectId" name="subjectId" class="form-select popup" required
                                onchange="updateLessonDropdown()">
                            <option value="">Select Subject</option>
                            <% if (subjects != null) {
                                for (Subject subject : subjects) { %>
                            <option value="<%= subject.getId() %>"><%= subject.getSubjectName() %>
                                (<%= subject.getCode() %>)
                            </option>
                            <% }
                            } %>
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-primary py-2 rounded-3 shadow-sm"
                                onclick="validateAndSubmit()">Save Question
                        </button>
                    </div>
                </form>
            </div>
